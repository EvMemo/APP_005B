...
public class SoftKeyViewUtil {
    ...
    public static void assistView (View view_A) {
        new SoftKeyViewUtil(view_A);
    }
    private SoftKeyViewUtil(View view_A) {
        //1､找到Activity的最外层布局控件，它其实是一个DecorView,它所用的控件就是FrameLayout=
        //2､获取到setContentView放进去的View
        mChildOfContent = view_A;
